...
class PreferencesHelper(context: Context) {
    ...
    companion object {
        ...
        private const val KEY_PHONE_PLAYER_ID = "phone_player_id"
    ...
    var phonePlayerId: String?
        get() = sharedPreferences.getString(KEY_PHONE_PLAYER_ID, null)
        set(value) = sharedPreferences.edit().putString(KEY_PHONE_PLAYER_ID, value).apply()
